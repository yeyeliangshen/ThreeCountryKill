...
export const GUOZHAN_ROSTER: RosterEntry[] = [
   ...
   */
  {
    ...
    pack: 'jun',
    status: 'partial',
    note: '君主特性 + 【君威】+ 专属装备【六龙骖驾】（♥K 宝物：你计算与其他角色的距离 -3；离开装备区即销毁）+ 【建安】（五子良将纛：同势力角色准备阶段可弃一张牌并封锁自己一张暗置武将牌，换一个五子良将技能，持续到君曹操下个回合开始；不能选场上已有的同名技能）+ 【挥鞭】（对一名魏势力角色造成1点伤害并令其摸两张牌，再令另一名已受伤魏势力角色回复1点体力）都已实现——均按用户核对后提供的口径。未实现：【总御】（缺完整文本）。',
  },
  {
    id: 'junliubei',
    name: '君刘备',
