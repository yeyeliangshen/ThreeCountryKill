...
const STANDARD_QUN: RosterEntry[] = [
  ...
  { id: 'mateng', name: '马腾', faction: 'qun', pack: 'standard', status: 'todo' },
  ...
  { id: 'panfeng', name: '潘凤', faction: 'qun', pack: 'standard', status: 'todo' },
  {
    id: 'zhangjiao',
    name: '张角',
    faction: 'qun',
...
const ZHEN: RosterEntry[] = [
  ...
  { id: 'xusheng', name: '徐盛', faction: 'wu', pack: 'zhen', status: 'todo' },
  {
    id: 'jiangqin',
    name: '蒋钦',
    faction: 'wu',
...
const BUCHEN: RosterEntry[] = [
  {
    ...
    pack: 'buchen',
    status: 'partial',
    missing: ['凿运（需要「本回合计算与其的距离视为1」的距离覆盖）'],
