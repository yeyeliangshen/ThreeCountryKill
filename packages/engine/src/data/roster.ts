...
const SHI: RosterEntry[] = [
  ...
  },
  {
    ...
    status: 'partial',
    primitives: ['awaken_skill'],
    missing: ['鹰扬（要改拼点流程：亮牌后、比大小前插一次 ±3 询问）', '魂殇（要「本回合临时拥有英姿/英魂」的机制）'],
    note: '激昂已实现（用/被打红色杀或决斗两个方向都摸一张；决斗方向用了新加的「单人目标锦囊也派发成为目标后」）。鹰扬与魂殇待做：前者要动拼点流程，后者要临时授予技能。副将位的「减半个阴阳阳鱼」（deputySlotHalfYang）已经就绪。',
  },
  {
    id: 'chenwu_dongxi',
    name: '陈武董袭',
